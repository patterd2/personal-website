...
The project's individual phase will focus on the application of these methods to mathematical models from physics and biology, such as predator-prey models, chemical oscillators, and reaction-diffusion equations. Students will use professional numerical continuation software — such as **AUTO**, **MATCONT**, or **BifurcationKit.jl** — to generate bifurcation diagrams and investigate how the qualitative behaviour of these models changes as parameters are varied.
