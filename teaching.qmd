...
::: {}
![Newton basins of attraction for a degree-3 polynomial, illustrating the fractal boundary between convergence regions of Newton's root-finding method.](assets/newton_basins_crop.png){fig-alt="Newton fractal basins of attraction"}
:::
::::
...
::: {}
![Stochastic Turing pattern formation in a Schnakenberg reaction-diffusion system, comparing the activator (A, left) and inhibitor (B, right) spatial profiles over time.](assets/schnak_crop.png){fig-alt="Schnakenberg Turing pattern heatmaps"}
:::
::::
